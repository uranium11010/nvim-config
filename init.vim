...
" Always show the signcolumn, otherwise it would shift the text each tifiletype plugin on
set omnifunc=syntaxcomplete#Completeme
...
" Use `[g` and `]g` to navigate diagnostics; C-k and C-j to navigate errors
